...
def test_summary_in_generation():
    ...
    expected_workplace_size_dist = sp.norm_dic(sp.get_workplace_size_distr_by_brackets(sp.default_config.datadir, state_location=pop.state_location, country_location=pop.country_location))
...
def test_contact_matrices_used():
    ...
    expected_contact_matrix_dic = sp.get_contact_matrix_dic(sp.default_config.datadir, sheet_name=pop.sheet_name)
...
def test_change_sheet_name():
    ...
    expected_contact_matrix_dic = sp.get_contact_matrix_dic(sp.default_config.datadir, sheet_name=test_pars.sheet_name)
...
def test_get_contact_matrix_dic_error_handling():
    ...
    with pytest.raises(RuntimeError) as excinfo:
        sp.get_contact_matrix_dic(sp.default_config.datadir, sheet_name="notexist")
