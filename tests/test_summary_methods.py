...
def test_summary_in_generation():
    ...
    enrollment_rates = pop.enrollment_rates_by_age  # a property of pop rather than stored data so make a copy here
    ...
    employment_rates = pop.employment_rates_by_age  # a property of pop rather than stored data so make a copy here
