...
pars = dict(
    ...
    location                        = None,  # seattle_metro results with school size distribution the same for all types
    use_default                     = True,
...
def test_school_sizes_by_type():
    ...
    for sc_type in enrollment_by_school_type:
        ...
        gen_school_size_distr[sc_type] = size_distr
