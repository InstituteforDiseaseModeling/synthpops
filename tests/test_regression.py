...
Expected files are generated by running this script with regenerate = True;
if set, baseline files will be copied to report folder. You can also run this
from the command line with

    python test_regression 'regenerate'
"""
