...
def test_smooth_binned_age_distribution(w_len):
    ...
    '''
    smoothed_age_distr, raw_age_distr = sp.get_smoothed_single_year_age_distr(sp.datadir, location=pars[0]['location'],
...
def test_smooth_binned_age_distribution_location(pars):
    smoothed_age_distr, raw_age_distr = sp.get_smoothed_single_year_age_distr(sp.datadir, location=pars['location'],
