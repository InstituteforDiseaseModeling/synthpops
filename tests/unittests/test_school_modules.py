...
#     teacher_teacher_edges = spsch.generate_edges_between_teachers(teachers_assigned, average_teacher_teacher_degree)
...
#             teacher_teacher_edges += spsch.generate_edges_between_teachers(teacher_group, average_teacher_teacher_degree)
#         edges += teacher_teacher_edges
#         return edges
#     else:
