...
Expected files are generated by running this script with cls.generateBaseline = True
if set, baseline files will be copied to report folder
"""
import fnmatch
import unittest
import os
...
class TestRegression(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.datadir = os.path.join(os.path.dirname(testdir), "data")
