...
popdict = sp.generate_microstructure_with_facilities(datadir, location, state_location, country_location, gen_pop_size, school_enrollment_counts_available=True, write=False, do_plot=do_plot, return_popdict=True)
