...
"""
Note: Before processing US Census Bureau data you should download it, rename it
according to the pattern specified below and place it in the folder specified.

The raw data files can be downloaded from the US Census Bureau using their
customized data explorer tables. The files of interest will have names with
patterns following the format
...
Now you should be able to process raw data from the US Census Bureau.
