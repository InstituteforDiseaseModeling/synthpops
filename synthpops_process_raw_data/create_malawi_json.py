...
enrollment_rates_df = pd.read_csv(os.path.join(raw_data_path, 'Malawi_enrollment_rates_by_age.csv'))
enrollment_rates_arr = sp.convert_df_to_json_array(enrollment_rates_df, cols=enrollment_rates_df.columns, int_cols=['age'])
