...
def make_contacts_2(popdict,weights_dic,n_contacts=30, use_age=True, use_sex=True, use_loc=False, use_social_layers=False,use_student_weights=False,student_age_min=3,student_age_max=20,worker_age_min=20,worker_age_max=70,student_teacher_ratio=30,directed=False, use_seattle = True):
    '''
    Generates a list of contacts for everyone in the population. popdict is a
    dictionary with N keys (one for each person), with subkeys for age, sex, location,
    and potentially other factors. This function adds a new subkey, contacts, which
