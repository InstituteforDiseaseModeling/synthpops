...
class Pop(sc.prettyobj):
    ...
    def __init__(self,
        ...
        Args:
            ...
            household_method (string)               : name of household generation method used. If 'infer_ages', then individuals ages are generated by placing them into households using the age of the head of households, household age mixing patterns, household sizes, and the census age distribution. If 'fixed_ages', then individuals are pre-assigned ages according to the census age distribution and placed into households using the age of the head of households,household age mixing patterns, and household sizes.
    ...
    def generate(self, verbose=False):
        ...
        if household_method == 'fixed_ages':
            ...
            homes_dic, homes, ages_left_to_assign_to_households = spltcf.generate_all_households_method_2(n_nonltcf, hh_sizes, hha_by_size, hha_brackets, cm_age_brackets, cm_age_by_brackets_dic, contact_matrix_dic, ltcf_adjusted_age_distr)
